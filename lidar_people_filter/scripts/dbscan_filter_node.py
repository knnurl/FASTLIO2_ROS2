...
class DBSCANFilterNode(Node):
    ...
    def __init__(self):
        ...
        # Cache all parameters once at startup — none of these change at runtime.
        # Avoids 18 × get_parameter() calls per incoming cloud in the hot path.
        self._p_cache = {k: self.get_parameter(k).value for k in [
